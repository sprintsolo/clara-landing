...
export const metadata: Metadata = {
  title: "Clara - AI Colleague for Professional Teams",
  description: "Are you starting research, review, and document creation from scratch every time? Clara is an AI colleague for professional teams where email, internal docs, AI research, and team reviews are all connected.",
